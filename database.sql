...
INSERT INTO `netadvert`.`advert` (`advert_name`,`user_id`,`created_at`,`updated_at`,`expire_date`,`cost`,`advert_rate`,`contact`,`description`,`is_sold`,`is_deleted`,`rent_sale`,`realestate_id`) VALUES ('Izdaje se stan','2', '2016-11-28 12:45:00', '2016-11-29 14:05:12', '2016-12-25', 25000, 3, '060/123-456', 'description', false, false, true, '1');
INSERT INTO `netadvert`.`advert` (`advert_name`,`user_id`,`created_at`,`updated_at`,`expire_date`,`cost`,`advert_rate`,`contact`,`description`,`is_sold`,`is_deleted`,`rent_sale`,`realestate_id`) VALUES ('HITNO se prodaje kuca!!!','2', '2017-11-14 18:19:00', '2016-11-14 18:19:00', '2016-12-11', 40000, 5, '060/123-456', 'description', false, false, true, '2');
