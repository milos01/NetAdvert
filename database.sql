...
INSERT INTO `netadvert`.`advert` (`advert_name`,`user_id`,`created_at`,`updated_at`,`expire_date`,`cost`,`advert_rate`,`contact`,`description`,`is_sold`,`is_deleted`,`rent_sale`,`realestate_id`) VALUES ('Izdaje se stan','2', '2016-11-28 12:45:00', '2016-11-29 14:05:12', '2017-12-11', 25000, 3, '060/123-456', 'description', false, false, true, '1');
