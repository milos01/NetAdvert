...
INSERT INTO `netadvert_test`.`realestate` (`realestate_name`,`area`,`cost`,`heating`,`category_id`,`type_id`,`location_id`) VALUES ('Stan na grbavici', 45, 25000, false, 1, 2, 1);
INSERT INTO `netadvert_test`.`realestate` (`realestate_name`,`area`,`cost`,`heating`,`category_id`,`type_id`,`location_id`) VALUES ('Kuca na novom naselju', 60, 40000, true, 1, 1, 2);
...
INSERT INTO `netadvert_test`.`picture` (`picture_name`,`user_id`,`realestate_id`,`is_profile`) VALUES ('Spoljasnji izgled', '2', '1', true);
INSERT INTO `netadvert_test`.`picture` (`picture_name`,`user_id`,`realestate_id`,`is_profile`) VALUES ('Dnevna soba', '2', '1', false);
INSERT INTO `netadvert_test`.`picture` (`picture_name`,`user_id`,`realestate_id`,`is_profile`) VALUES ('Kuhinja', '2', '1', false);
INSERT INTO `netadvert_test`.`picture` (`picture_name`,`user_id`,`realestate_id`,`is_profile`) VALUES ('Kupatilo', '2', '1', false);
INSERT INTO `netadvert_test`.`picture` (`picture_name`,`user_id`,`realestate_id`,`is_profile`) VALUES ('Dnevna soba', '2', '2', true);
INSERT INTO `netadvert_test`.`picture` (`picture_name`,`user_id`,`realestate_id`,`is_profile`) VALUES ('Spavaca soba', '2', '2', false);
INSERT INTO `netadvert_test`.`picture` (`picture_name`,`user_id`,`realestate_id`,`is_profile`) VALUES ('Kuhinja', '2', '2', false);


INSERT INTO `netadvert_test`.`advert` (`user_id`,`created_at`,`updated_at`,`expire_date`,`advert_rate`,`contact`,`description`,`is_sold`,`is_deleted`,`rent_sale`,`realestate_id`) VALUES ('2', '2016-11-28 12:45:00', '2016-11-29 14:05:12', '2016-12-25', 4, '060/123-456', 'description', false, false, true, '1');
INSERT INTO `netadvert_test`.`advert` (`user_id`,`created_at`,`updated_at`,`expire_date`,`advert_rate`,`contact`,`description`,`is_sold`,`is_deleted`,`rent_sale`,`realestate_id`) VALUES ('2', '2016-11-14 18:19:00', '2016-11-14 18:19:00', '2016-12-11', 5, '060/123-456', 'description', false, false, true, '2');
